...
async function test() {
    try {
        ...
        console.log("=== EXECUTING ALSO BOUGHT QUERY (ONLY SUPPLIER 15500) ===");
        const r1 = await conn.execute(`
            ...
            WHERE r.POSICAO_RANKING <= 3
              AND m_all.CODOPER = 'S'
              AND p_all.CODFORNEC = 15500 -- Apenas produtos Bom Princípio
            ORDER BY r.POSICAO_RANKING, r.TOTAL_PONTOS DESC, c.CODCLI, c.DTSAIDA ASC, m_all.CODPROD ASC
        `);
        
        console.log("Detailed Bom Princípio Products:");
