...
async function run() {
    try {
        ...
        console.log('Testing Part 2 with PCMOV (last 30 days) as DRIVING table...');
        console.time('Driving PCMOV Time');
        ...
        const query = `
            ...
            JOIN BRAGO.PCLOGDESBLOQUEIO DE ON DE.CODPROD = M.CODPROD
                AND DE.DTDESBLOQUEIO >= TRUNC(SYSDATE)
                AND (
        ...
        console.timeEnd('Driving PCMOV Time');
